...
const FEATURES = [
  ...
  {
    icon: '🎥',
    title: '+10 crédits pour un témoignage',
  ...
  {
    icon: '🎁',
    title: '10 crédits = 10€ Temu',
    desc: 'Dès 10 crédits, demande ton bon Temu de 10€. Le gérant te l\'envoie directement sur WhatsApp.',
